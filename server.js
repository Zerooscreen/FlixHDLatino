...
// ---------- PROTEKSI BOT SEDERHANA TANPA INSTALL MODULE ----------
...
app.get('/watch/:type/:id', async (req, res) => {
  ...
  try {
    ...
    const headHtml = head({
      title: 'Redirigiendo al reproductor · FlixHDLatino',
      description: DEFAULT_DESC,
...
app.get('/movie', async (req, res) => {
  ...
  `;
  res.send(layout({ headHtml: head({ title: 'Películas · FlixHDLatino', description: DEFAULT_DESC, url: `${SITE_URL}/movie` }), bodyHtml, activeTab: 'movie' }));
});
...
app.get('/tv', async (req, res) => {
  ...
  `;
  res.send(layout({ headHtml: head({ title: 'Series · FlixHDLatino', description: DEFAULT_DESC, url: `${SITE_URL}/tv` }), bodyHtml, activeTab: 'tv' }));
});
